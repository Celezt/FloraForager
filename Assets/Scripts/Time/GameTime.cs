...
public class GameTime : Singleton<GameTime>, IStreamable<GameTime.Data>
{
    [Space(5), Header("Game")]
    ...
    public void Load()
    {
        OnLoad(GameManager.Stream.Get(_Guid) as Data);
    }
    ...
    public decimal ElapsedTime => _Data.ElapsedTime;
    ...
    private void Update()
    {
        _Data.ElapsedTime += (decimal)Time.deltaTime;
    }
